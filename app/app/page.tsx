  ...
  return (
    <PageContainer>
        ...
        <SectionCard>
          <p className="text-sm text-muted-foreground">
            {!isSupabaseConfigured
              ? "You’re exploring Sanjeevani in demo mode. Sign in to see your live consultations, records and reminders."
      ...
      <p className="pb-8 pt-2 text-center text-xs text-muted-foreground">
        Sanjeevani · संजीवनी — bringing healthcare closer in distance, cost and language.
      </p>
    </PageContainer>
  );
}
