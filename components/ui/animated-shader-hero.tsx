...
void main(){gl_Position=position;}`;
  ...
  const loop = (now: number) => {
    ...
    // Skip the (heavy) fragment-shader draw when off-screen or tab hidden.
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white">
        ...
        <div className="text-center space-y-6 max-w-5xl mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto animate-fade-in-up animation-delay-600">
            <p className="text-lg md:text-xl lg:text-2xl text-cyan-50/85 font-light leading-relaxed">
              {subtitle}
            </p>
          </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10 animate-fade-in-up animation-delay-800">
              {buttons.primary && (
                <button
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-cyan-400 to-emerald-500 hover:from-cyan-500 hover:to-emerald-600 text-[#03141a] rounded-full font-semibold text-lg transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-cyan-500/25 cursor-pointer"
                >
              ...
              {buttons.secondary && (
                <button
                  ...
                  className="px-8 py-4 bg-cyan-500/10 hover:bg-cyan-500/20 border border-cyan-300/30 hover:border-cyan-300/50 text-cyan-100 rounded-full font-semibold text-lg transition-all duration-300 hover:scale-105 backdrop-blur-sm cursor-pointer"
                >
...
* Recoloured to the Sanjeevani cyan/teal/green palette.
*/
precision highp float;
out vec4 O;
...
void main(void) {
	...
	for (float i=1.; i<12.; i++) {
		...
		col=mix(col,vec3(bg*.05,bg*.16,bg*.2),d);
	}
	O=vec4(col,1);
}`;
