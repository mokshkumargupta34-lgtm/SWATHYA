  ...
  return (
    <div ref={containerRef} className="hero-container cosmos-style">
      ...
      <div ref={menuRef} className="side-menu" style={{ visibility: 'hidden' }}>
        ...
        <div className="vertical-text">SWASTHYA</div>
      </div>
      ...
      <div className="hero-content cosmos-content">
        ...
        <div ref={subtitleRef} className="hero-subtitle cosmos-subtitle">
          <p className="subtitle-line">
            Where care meets every life,
          </p>
          <p className="subtitle-line">
            we shape a healthier tomorrow
          </p>
        </div>
      </div>
      ...
      <div className="scroll-sections">
       {[...Array(2)].map((_, i) => {
          ...
          const subtitles = {
            0: {
              line1: 'Where care meets every life,',
              line2: 'we shape a healthier tomorrow'
            },
            1: {
              line1: 'Beyond distance, cost and language,',
              line2: 'lies care within everyone’s reach'
            },
            2: {
              line1: 'In the space between need and help,',
              line2: 'we find the essence of true wellbeing'
            }
          };
